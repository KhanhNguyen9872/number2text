#!/bin/bash
# for, sed, awk, printf, function, read, cut
# Setup variable
red='\033[1;31m'
green='\033[1;32m'
yellow='\033[1;33m'
...
leng_num=([2]="mươi" [3]="trăm" [4]="nghìn," [5]="mươi" [6]="trăm" [7]="triệu," [8]="mươi" [9]="trăm" [10]="tỷ," [11]="mươi" [12]="trăm" [13]="nghìn tỷ," [14]="mươi" [15]="trăm" [16]="triệu tỷ,")
